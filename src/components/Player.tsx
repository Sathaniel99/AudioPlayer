  ...
  return (
    <div className='px-15 py-10 flex flex-col justify-center relative'>
      ...
      <div className='my-2 text-center'>
        ...
        <h2 className='text-3xl h-9'>{currentSong.name ? currentSong.name : <span className='flex gap-3'><div className='flex'><p className='m-0 text-red-600'>A</p><p className='m-0 text-yellow-600'>u</p><p className='m-0 text-blue-600'>d</p><p className='m-0 text-orange-600'>i</p><p className='m-0 text-pink-600'>o</p><p className='m-0 text-purple-600'>-</p><p className='m-0 text-red-600'>P</p><p className='m-0 text-yellow-600'>l</p><p className='m-0 text-blue-600'>a</p><p className='m-0 text-orange-600'>y</p><p className='m-0 text-pink-600'>e</p><p className='m-0 text-purple-600'>r</p><p className='m-0 text-red-600'> </p><p className='m-0 text-yellow-600'>W</p><p className='m-0 text-blue-600'>e</p><p className='m-0 text-orange-600'>b</p></div><div className='flex'><p className='m-0'>v</p><p className='m-0 text-'>1</p><p className='m-0 text-'>.</p><p className='m-0 text-'>0</p></div></span>}</h2>
      </div>
